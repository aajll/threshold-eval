# Contributing to threshold-eval

threshold-eval is a small C library providing configurable threshold evaluation
for classifying sampled values against validated warning/trip limits. It is
