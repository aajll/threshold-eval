...
threshold-eval is a small threshold evaluation library with no network
stack, no external dependencies, and no dynamic memory allocation. The
primary attack surface is integer overflow in threshold comparisons and
out-of-bounds access in threshold arrays.
